...
package com.lang.ftd.common.tools.mybatisUtils.pagination;
...
import com.lang.ftd.common.tools.mybatisUtils.pagination.dialect.DBMS;
import com.lang.ftd.common.tools.mybatisUtils.pagination.dialect.Dialect;
import com.lang.ftd.common.tools.mybatisUtils.pagination.dialect.DialectClient;
import com.lang.ftd.common.tools.mybatisUtils.pagination.helper.CountHelper;
       ...
       /* String dialectClass = p.getProperty("dialectClass");
        ...
        if (StringHelper.isEmpty(dialectClass)) {
			...
			try {
				...
				e.printStackTrace();
			} //Reflections.instance(dialectClass);
           // Preconditions.checkNotNull(dialect1, "dialectClass is not found!");
