...
package com.lang.ftd.common.tools.mybatisUtils.pagination.helper;
...
import com.lang.ftd.common.tools.mybatisUtils.pagination.dialect.Dialect;
...
public class CountHelper {
	...
	public static int getCount(final String sql, final Connection connection, final MappedStatement mappedStatement, final Object parameterObject,
		...
		try {
			...
			CountHelper.setParameters(countStmt, mappedStatement, countBS, countBsObject);
    ...
    public static void setParameters(PreparedStatement ps, MappedStatement mappedStatement, BoundSql boundSql, MetaObject meta) throws SQLException {
            ...
            for (int i = 0; i < parameterMappings.size(); i++) {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {
                    ...
                    if (parameterObject == null) {
                    	...
                    	value = meta == null ? null : meta.getValue(propertyName);
                    }else {
